...
func (pu *PatientUpdate) AddAppointment(s ...*Specializedappoint) *PatientUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
func (pu *PatientUpdate) RemoveAppointment(s ...*Specializedappoint) *PatientUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
// AddAppointment adds the appointment edges to Specializedappoint.
func (puo *PatientUpdateOne) AddAppointment(s ...*Specializedappoint) *PatientUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
// RemoveAppointment removes appointment edges to Specializedappoint.
func (puo *PatientUpdateOne) RemoveAppointment(s ...*Specializedappoint) *PatientUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
